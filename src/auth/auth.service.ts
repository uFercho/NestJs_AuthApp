...
import { RegisterUserDto, LoginDto, UpdateAuthDto, CreateUserDto } from './dto/index';
...
export class AuthService {
  ...
  async create(createUserDto: CreateUserDto): Promise<User> {
    ...
    try {
      ...
      console.log('🚀 | AuthService | create | finally');
  ...
  async findUserById( id: string ) {
    ...
    const { password, ...userResquest } = user.toJSON();
    return userResquest;
  }
